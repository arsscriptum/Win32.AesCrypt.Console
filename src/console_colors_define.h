...
//==============================================================================
//
//   console_colors_define.h - exported_h
//
//==============================================================================
...
namespace console
{
    ...
    const std::string GRAY                      = "\033[0;37m";  // Light Gray text
    // Bold
    ...
    // High Intensity
    const std::string DARK_GRAY                 = "\033[0;90m";  // Dark Gray text
    ...
    // Additional Formatting Codes (italic, inverse, hidden)
    const std::string ITALIC                    = "\033[3m";            // Italic text (may not work in all terminals)
    const std::string INVERSE                   = "\033[7m";           // Inverted colors (background and text)
    const std::string HIDDEN                    = "\033[8m";            // Hidden text (may not be visible)
}
